<template>
  ...
  <div class="collapse in" id="page-renamer-tools">
    Language:
    Python 3
    <br/><br/>
    APIs/Libraries/Methodologies:<br/>
    Object Oriented Programming, TKinter, PIL/Pillow Image API, PyMuPDF, PyTesseract
    <br/><br/>
  </div>
  <h3>The Project</h3>
  ...
  <div class="collapse in" id="page-renamer-v1">
  ...
  <div class="collapse in" id="page-renamer-v2">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="public/Files/renamerCalib.jpg" target="_blank">
          <img src="public/Files/renamerCalib.jpg" alt="Calibration System" style="width:100%">
          <div class="caption">
    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="public/Files/Selection-box.png" target="_blank">
          <img src="public/Files/Selection-box.png" alt="User Text Selection" style="width:100%">
          <div class="caption">
            <p>User-selected box shown, which will be used across all newly scanned files in that folder.</p>
          </div>
        </a>
      </div>
    </div>
